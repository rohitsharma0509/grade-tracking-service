...
class StudentControllerTest {
	...
	@Test
	void testAddStudentForException() {
	...
	@Test
	void testAddStudentForSuccessCase() {
	...
	@Test
	void testGetStudentDetailsForException() {
	...
	@Test
	void testGetStudentDetailsForBadRequest() {
	...
	@Test
	void testGetStudentDetailsForSuccessCase() {
		StudentDto studentDto = new StudentDto();
		studentDto.setId(1L);
